...
namespace Domain.Specs.for_Improvable.when_validating_register_improvable
{
    ...
    public class and_the_repository_name_is_invalid : given.an_input_validator_for<and_the_repository_name_is_invalid>
    {
        ...
        Establish context = () => 
        {
            Action<RegisterImprovable> invalidation = _ => _.Repository = RepositoryFullName.Empty;
