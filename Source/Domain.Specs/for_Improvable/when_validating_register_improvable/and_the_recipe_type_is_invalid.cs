...
namespace Domain.Specs.for_Improvable.when_validating_register_improvable
{
    ...
    public class and_the_recipe_type_is_invalid : given.an_input_validator_for<and_the_recipe_type_is_invalid>
    {
        ...
        Establish context = () => 
        {
            Action<RegisterImprovable> invalidation = _ => _.Recipe = RecipeType.Empty;
        ...
        It should_indicate_that_the_recipe_is_invalid = () => results.ShouldHaveInvalidProperty(nameof(RegisterImprovable.Recipe));
    }   
}